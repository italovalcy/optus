...
class KytosInstall:
    ...
    def enable_core_napps():
        ...
        (ENABLED_PATH / 'optus').mkdir(parents=True, exist_ok=True)
        for napp in CORE_NAPPS:
            napp_path = Path('optus', napp)
...
class DevelopMode(develop):
    ...
    def _create_folder_symlinks():
        ...
        (ENABLED_PATH / 'optus').mkdir(parents=True, exist_ok=True)
        dst = ENABLED_PATH / Path('optus', NAPP_NAME)
    ...
    def _create_file_symlinks():
        ...
        dst = CURRENT_DIR / 'optus' / '__init__.py'
        symlink_if_different(src, dst)
